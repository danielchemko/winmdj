            ...
            class StubImplementationMapImpl (
                ...
                override fun toString(): String {
                   return "ImplementationMap/${getToken()}"
                }
                ...
                override fun copy(rowNum: Int?): StubImplementationMapImpl {
                   return StubImplementationMapImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
...
override fun getMemberForwarded(): com.github.danielchemko.winmdj.core.mdspec.MemberForwarded? {
    return stub.lookupInterfaceReferent(CLRMetadataType.IMPL_MAP, 1, com.github.danielchemko.winmdj.core.mdspec.MemberForwarded::class)
}

override fun getTargetScope(): com.github.danielchemko.winmdj.core.mdspec.ModuleReference? {
    return stub.lookupConcreteReferent(CLRMetadataType.IMPL_MAP, 3, com.github.danielchemko.winmdj.core.mdspec.ModuleReference::class)
}
            }