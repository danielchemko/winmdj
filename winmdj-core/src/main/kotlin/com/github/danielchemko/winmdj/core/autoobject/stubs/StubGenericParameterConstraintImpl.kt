            ...
            class StubGenericParameterConstraintImpl (
                ...
                override fun toString(): String {
                   return "GenericParameterConstraint/${getToken()}"
                }
                ...
                override fun copy(rowNum: Int?): StubGenericParameterConstraintImpl {
                   return StubGenericParameterConstraintImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
