            ...
            class StubFieldMarshalImpl (
                ...
                override fun copy(rowNum: Int?): StubFieldMarshalImpl {
                   return StubFieldMarshalImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
...
override fun getParent(): com.github.danielchemko.winmdj.core.mdspec.HasFieldMarshal? {
    return stub.lookupInterfaceReferent(CLRMetadataType.FIELD_MARSHAL, 0, com.github.danielchemko.winmdj.core.mdspec.HasFieldMarshal::class)
}
            }