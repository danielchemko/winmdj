            ...
            class StubMethodSemanticsImpl (
                ...
                override fun copy(rowNum: Int): StubMethodSemanticsImpl {
                   return StubMethodSemanticsImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum)
                }
...
override fun getParent(): com.github.danielchemko.winmdj.core.mdspec.HasSemantics? {
