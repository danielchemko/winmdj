            ...
            class StubExportedTypeImpl (
                ...
                override fun copy(rowNum: Int?): StubExportedTypeImpl {
                   return StubExportedTypeImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
...
override fun getImplementation(): com.github.danielchemko.winmdj.core.mdspec.Implementation? {
    return stub.lookupInterfaceReferent(CLRMetadataType.EXPORTED_TYPE, 4, com.github.danielchemko.winmdj.core.mdspec.Implementation::class)
}
