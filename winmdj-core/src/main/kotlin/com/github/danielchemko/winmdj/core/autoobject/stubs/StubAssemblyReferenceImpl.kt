            ...
            class StubAssemblyReferenceImpl (
                ...
                override fun copy(rowNum: Int?): StubAssemblyReferenceImpl {
                   return StubAssemblyReferenceImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
...
override fun getFlags(): kotlin.collections.List<com.github.danielchemko.winmdj.core.mdspec.AssemblyFlags> {
    return stub.lookupBitsetEnum(CLRMetadataType.ASSEMBLY_REF, 1, com.github.danielchemko.winmdj.core.mdspec.AssemblyFlags::class)
}
