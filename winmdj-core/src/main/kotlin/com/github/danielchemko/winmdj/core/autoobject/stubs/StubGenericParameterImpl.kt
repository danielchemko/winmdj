...
import com.github.danielchemko.winmdj.core.mdspec.GenericParameter
...
class StubGenericParameterImpl(
    ...
    override fun copy(rowNum: Int): StubGenericParameterImpl {
        return StubGenericParameterImpl::class.constructors.first()
    ...
    override fun getOwner(): com.github.danielchemko.winmdj.core.mdspec.TypeOrMethodDef? {
        return stub.lookupInterfaceReferent(
            CLRMetadataType.GENERIC_PARAM,
            2,
            com.github.danielchemko.winmdj.core.mdspec.TypeOrMethodDef::class
        )
    }
