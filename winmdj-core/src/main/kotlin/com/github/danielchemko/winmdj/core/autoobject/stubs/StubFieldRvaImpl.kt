            ...
            class StubFieldRvaImpl (
                ...
                override fun copy(rowNum: Int?): StubFieldRvaImpl {
                   return StubFieldRvaImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
       
            override fun getField(): com.github.danielchemko.winmdj.core.mdspec.Field? {
    return stub.lookupConcreteReferent(CLRMetadataType.FIELD_RVA, 1, com.github.danielchemko.winmdj.core.mdspec.Field::class)
}
