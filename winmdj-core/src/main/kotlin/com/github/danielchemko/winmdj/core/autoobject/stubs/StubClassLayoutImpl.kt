            ...
            class StubClassLayoutImpl (
                ...
                override fun copy(rowNum: Int?): StubClassLayoutImpl {
                   return StubClassLayoutImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
...
override fun getParent(): com.github.danielchemko.winmdj.core.mdspec.TypeDefinition? {
    return stub.lookupConcreteReferent(CLRMetadataType.CLASS_LAYOUT, 2, com.github.danielchemko.winmdj.core.mdspec.TypeDefinition::class)
}
            }