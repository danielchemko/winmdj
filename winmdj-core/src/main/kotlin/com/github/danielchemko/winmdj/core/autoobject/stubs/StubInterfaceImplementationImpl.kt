...
import com.github.danielchemko.winmdj.core.mdspec.InterfaceImplementation
...
class StubInterfaceImplementationImpl(
    ...
    override fun copy(rowNum: Int): StubInterfaceImplementationImpl {
        return StubInterfaceImplementationImpl::class.constructors.first()
    ...
    override fun getInterface(): com.github.danielchemko.winmdj.core.mdspec.TypeDefOrRef {
        return stub.lookupInterfaceReferent(
            CLRMetadataType.INTERFACE_IMPL,
            1,
