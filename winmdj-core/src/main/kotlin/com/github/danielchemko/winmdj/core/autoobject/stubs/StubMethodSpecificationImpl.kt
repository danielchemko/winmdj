            ...
            class StubMethodSpecificationImpl (
                ...
                override fun copy(rowNum: Int?): StubMethodSpecificationImpl {
                   return StubMethodSpecificationImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
       
            override fun getMethod(): com.github.danielchemko.winmdj.core.mdspec.MethodDefOrRef? {
    return stub.lookupInterfaceReferent(CLRMetadataType.METHOD_SPEC, 0, com.github.danielchemko.winmdj.core.mdspec.MethodDefOrRef::class)
}
