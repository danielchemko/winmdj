            ...
            class StubNestedClassImpl (
                ...
                override fun copy(rowNum: Int?): StubNestedClassImpl {
                   return StubNestedClassImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
       
            override fun getEnclosingType(): com.github.danielchemko.winmdj.core.mdspec.TypeDefinition {
    return stub.lookupConcreteReferent(CLRMetadataType.NESTED_CLASS, 1, com.github.danielchemko.winmdj.core.mdspec.TypeDefinition::class)!!
}

override fun getNestedClass(): com.github.danielchemko.winmdj.core.mdspec.TypeDefinition {
    return stub.lookupConcreteReferent(CLRMetadataType.NESTED_CLASS, 0, com.github.danielchemko.winmdj.core.mdspec.TypeDefinition::class)!!
}
            }