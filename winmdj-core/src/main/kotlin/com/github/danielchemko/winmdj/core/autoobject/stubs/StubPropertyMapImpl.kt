            ...
            class StubPropertyMapImpl (
                ...
                override fun copy(rowNum: Int?): StubPropertyMapImpl {
                   return StubPropertyMapImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
       
            override fun getParent(): com.github.danielchemko.winmdj.core.mdspec.TypeDefinition? {
    return stub.lookupConcreteReferent(CLRMetadataType.PROPERTY_MAP, 0, com.github.danielchemko.winmdj.core.mdspec.TypeDefinition::class)
}

                            override fun getProperties(): kotlin.collections.List<com.github.danielchemko.winmdj.core.mdspec.Property> {
                                val column = 
return stub.lookupList(CLRMetadataType.PROPERTY_MAP, 1, 1, 3, com.github.danielchemko.winmdj.core.mdspec.Property::class)
                            }
            }