...
override fun getVersionRaw(): kotlin.ULong {
    return stub.lookupTableValue(CLRMetadataType.ASSEMBLY, 1, kotlin.ULong::class)!!
                            ...
                            override fun getSecurityAttribute(): com.github.danielchemko.winmdj.core.mdspec.SecurityAttribute? {
                                val stubsCursor = getStub().getObjectMapper().getCursor(com.github.danielchemko.winmdj.core.mdspec.Assembly::class.java)
var rowRef = getStub().getRowNumber() - 1;
var highestMethod: com.github.danielchemko.winmdj.core.mdspec.Assembly = this
