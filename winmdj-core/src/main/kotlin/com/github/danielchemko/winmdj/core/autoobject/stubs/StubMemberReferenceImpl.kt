...
import com.github.danielchemko.winmdj.core.mdspec.MemberReference
...
class StubMemberReferenceImpl(
    ...
    override fun copy(rowNum: Int): StubMemberReferenceImpl {
        return StubMemberReferenceImpl::class.constructors.first()
    ...
    override fun getParent(): com.github.danielchemko.winmdj.core.mdspec.MemberRefParent? {
        return stub.lookupInterfaceReferent(
            CLRMetadataType.MEMBER_REF,
            0,
            com.github.danielchemko.winmdj.core.mdspec.MemberRefParent::class
        )
    }
