            ...
            class StubMemberReferenceImpl (
                ...
                override fun toString(): String {
                   return "MemberReference/${getToken()}"
                }
                ...
                override fun copy(rowNum: Int?): StubMemberReferenceImpl {
                   return StubMemberReferenceImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
