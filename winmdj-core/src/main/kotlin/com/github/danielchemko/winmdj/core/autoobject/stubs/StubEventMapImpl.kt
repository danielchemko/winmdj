            ...
            class StubEventMapImpl (
                ...
                override fun copy(rowNum: Int?): StubEventMapImpl {
                   return StubEventMapImpl::class.constructors.first().call(stub.getObjectMapper(), stub.getNavigator(), rowNum ?: getRowNumber())
                }
       
                                        override fun getEvents(): kotlin.collections.List<com.github.danielchemko.winmdj.core.mdspec.Event> {
                                val column = 
return stub.lookupList(CLRMetadataType.EVENT_MAP, 1, 1, 3, com.github.danielchemko.winmdj.core.mdspec.Event::class)
                            }

override fun getParent(): com.github.danielchemko.winmdj.core.mdspec.TypeDefinition? {
    return stub.lookupConcreteReferent(CLRMetadataType.EVENT_MAP, 0, com.github.danielchemko.winmdj.core.mdspec.TypeDefinition::class)
}
            }